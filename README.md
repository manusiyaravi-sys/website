...
<header>
    <img src="rolex.png" alt="ROLEX Logo"> 
    <h1>ROLEX</h1>
</header>
...
<nav>
    ...
    <a href="booking.html">to place the order</a>
</nav>

<div class="banner">
    <h2>10% Off This Weekend</h2>
    <p>Don't miss out on our special offer! Visit us every weekend and enjoy pastry at discounted prices.</p>
</div>

<div class="sections">
    <div class="section">
        <img src="menuu.PNG" alt="Menu"> 
        <h3>Our New Menu</h3>
...
<footer>
    <p>Designed and Developed by Manusiya Ravi<br> 212224220117</p>
</footer>
...
<div class="menu-section">
    ...
    <div class="menu-items">
        <div class="menu-item">
            <img src="Cupcakes.PNG" alt="Dish 1">
            <h3>Sweet pufy Cupcakes</h3>
            <p>puff cakes made with less buter ,refined wheat is not used.</p>
            <span>Rs. 120</span>
        </div>
        <div class="menu-item">
            <img src="milkcake.PNG" alt="Dish 2">
            <h3>Spongy cake</h3>
            <p>Freshly baked cake topped with bery, fruits, and cream.</p>
            <span>Rs. 320</span>
        </div>
        <div class="menu-item">
            <img src="puff.PNG" alt="Dish 3">
            <h3>fluffy puff</h3>
            <p>zero oil baked puff.</p>
            <span>Rs. 160</span>
        </div>
        <div class="menu-item">
            <img src="tiramisu.PNG" alt="Dish 4">
            <h3>yummy tummy tiramisu</h3>
            <p>soft,ceamy and plufy</p>
            <span>Rs. 340</span>
        </div>
    </div>
</div>
...
<html>
<head>
    <title>Book a Table - ROLEX</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            margin: 0;
